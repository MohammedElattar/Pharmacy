...
class customers extends Controller
{
     ...
     */
    private $tbl_name = "customers";
    private $layout = "layouts.customers.customers";
    private $layout_add = "layouts.customers.customers_add";
    private $layout_edit = "layouts.customers.customers_edit";
    private $unique_name = "name";
    private $unique_id = "id";
    private $main_name = "customers";
