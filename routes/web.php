...
Route::middleware('auth')->group(function () {
    ...
    Route::get("/expired_products", [expired_products::class, 'index'])->name("exp_prod");
    Route::get("/expired_products/delete/{id}", [expired_products::class, 'delete'])->name("delete-exp_prod")->where("id", '[0-9]+');
